...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['you are awesome','Type khelp'];
    var i = -1;
    var j = 0;
...
${prefix}kimage/صورة السيرفر
${prefix}kmembers/عرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص
${prefix}kid/معلومات عنك
${prefix}kbans / عدد الاشخاص المبندة 
${prefix}kavatar/صورتك او صورة الي تمنشنو
${prefix}/يكرر الي تقولو بشكل حلو
${prefix}emoji <any things>/لتحويل اي كلمه تقولها الي ايموجي
${prefix}/لدعوة البوت الى سيرفرك
...
**
${prefix}kmove @user /  لسحب الشخص الى روومك
${prefix}kbc / رسالة جماعية الى كل اعضاء السيرفر
${prefix}kbk / رسالة جماعيه مع
${prefix}krolebc <everyone or @role> / راسال رساله جماعيه لرتبه محدده
${prefix}krole @user <rank> / لأعطاء رتبة لعضو معين
${prefix}kroleremove @user <rank> / لازالة الرتبة من شخص معين
${prefix}kgive all <rank> / لأعطاء رتبة للجميع
${prefix}kgive humans <rank> / لأعطاء رتبة للاشخاص فقط
${prefix}kgive bots <rank> / لأعطاء رتبة لجميع البوتات
${prefix}khchannel / اخفاء الشات
${prefix}kschannel / اضهار الشات المخفية
${prefix}kclr <numbr> / مسح الشات بعدد
${prefix}kclear / مسح الشات
${prefix}kmute @user <time> / اعطاء العضو ميوت 
${prefix}kunmute @user / لفك الميوت عن الشخص 
${prefix}kkick @user <reason> / طرد الشخص من السيرفر
${prefix}kban @user <reason> / حضر الشخص من السيرفر
${prefix}kmutechannel / تقفيل الشات
${prefix}kunmutechannel / فتح الشات
${prefix}kdc / مسح كل الرومات
${prefix}kdr / <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات
${prefix}kct <name> / انشاء شات
${prefix}kcv <name> / انشاء رووم فويس
${prefix}ktemp / لانشاء روم مؤقت
${prefix}kdelet <name> / مسح الشات او الرووم فويس
${prefix}kmake <number> / ينشا لك الوان مع كم الوان تبي
${prefix}kcolor <number> / لختيار لون
${prefix}kdeletecolors <number> / لحذف الالوان
**
   `,`
        ***__Music orders__***
**
${prefix}kplay / لتشغيل أغنية برآبط أو بأسم
${prefix}kskip / لتجآوز الأغنية الحآلية
${prefix}kpause / إيقآف الأغنية مؤقتا
${prefix}kresume / لموآصلة الإغنية بعد إيقآفهآ مؤقتا
${prefix}kvol / لتغيير درجة الصوت 100 - 0
${prefix}kstop / لإخرآج البوت من الروم
${prefix}knp / لمعرفة الأغنية المشغلة حآليا
${prefix}kqueue / لمعرفة قآئمة التشغيل
**
        ***__Games orders__***
 **       
${prefix}krps / حجر ورقة مقص
${prefix}kspeed / اسرع كتابة
${prefix}kquas / اسئلة عامة
${prefix}kنكت / نكت 
${prefix}kلعبة فكك / فكك
${prefix}kعواصم عشوائي/عواصم
${prefix}kلعبة كت تويت / كت تويت
${prefix}kroll <number> / قرعة
${prefix}kلو خيروك بطريقة حلوة / لو خيروك
${prefix}kلعبة مريم / مريم
${prefix}kفوائد ونصائح  / هل تعلم
${prefix}kيعطيك عقابات قاسية / عقاب 
=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.
